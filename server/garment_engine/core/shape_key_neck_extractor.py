"""
===============================================================================
Shape Key Neck Extractor V3 (Temporary 20% Version)
===============================================================================
...
Temporary heuristic:
    Uses the lowest 20% of affected vertices to compute the neck
    center because some MPFB avatars include lower-head vertices
    inside the neck circumference shape key.

TODO:
    Replace this heuristic with a geometry-based neck ring detector.
...
class ShapeKeyNeckExtractor:
    ...
    def extract(avatar_obj):
        ...
        # =====================================================
        # TEMPORARY:
        # Use the lowest 20% of affected vertices.
        # =====================================================
        ...
        sample_count = max(
            ...
            int(
                ...
                *
                ShapeKeyNeckExtractor.COLLAR_PERCENTAGE
            )
        )

        collar_vertices = affected_vertices[:sample_count]
        ...
        print("Collar vertices (20%):")
        print(len(collar_vertices))
